...
if (process.env.NODE_ENV === 'test') {
    ...
    Async.auto({
        ...
        projectName: function (done) {
            ...
            var promptOptions = {
                default: defaultValues.projectName || 'Analytics Collector'
            };
        ...
        mongodbUrl: ['companyName', function (done) {
            ...
            var promptOptions = {
                default: defaultValues.mongodbUrl || 'mongodb://localhost:27017/analytics-collector'
            };
        ...
        port: ['apiPath', function (done) {
            ...
            var promptOptions = {
                default: defaultValues.port || 4300
            };
