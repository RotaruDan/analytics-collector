 ...
 *      }
 *
 * Manages a collection of authorization tokens, named 'attempts', with the following documents:
 *
 *     {
...
module.exports = (function () {
    ...
    var attempts = new Collection(require('./db'), 'attempts');
     ...
     */
    attempts.start = function (playerId, version) {
     ...
     */
    attempts.track = function (authorization) {
        return attempts.find({
            ...
            if (authToken) {
                ...
                return attempts.findAndModify(authToken._id, set);
            }
