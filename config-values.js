 ...
 * Is useful for a faster parse of some values such as mongo host/port.
 *
 * @param conf
 * @param prefix
 * @param links
...
exports.defaultValues = {
    projectName: 'Analytics Collector',
    companyName: 'e-UCM Research Group',
    mongoHost: 'localhost',
    mongoPort: '27017',
    mongodbUrl: 'mongodb://localhost:27017/analytics-collector',
    apiPath: '/api',
    port: 4300,
    a2Host: 'localhost',
    a2Port: '3000',
...
exports.testValues = {
    projectName: 'analytics-collector (Test)',
    companyName: 'e-UCM Research Group (Test)',
    mongoHost: 'localhost',
    mongoPort: '27017',
    mongodbUrl: 'mongodb://localhost:27017/analytics-collector-test', // This must be different than 'exports.defaultValues.mongodbUrl'
    apiPath: '/api',
    port: 3330,
    a2Host: 'localhost',
    a2Port: '3000',
...
exports.defaultValues.mongodbUrl = 'mongodb://' + exports.defaultValues.mongoHost + ':' + exports.defaultValues.mongoPort + '/analytics-collector';
